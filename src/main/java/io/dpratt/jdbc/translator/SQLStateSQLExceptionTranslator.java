 ...
 * the {@link java.sql.SQLException} based on the first two digits (the SQL state "class").
...
public class SQLStateSQLExceptionTranslator extends AbstractFallbackSQLExceptionTranslator {
    ...
    protected static final Logger LOGGER = LoggerFactory.getLogger(SQLStateSQLExceptionTranslator.class);
